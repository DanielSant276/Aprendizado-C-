        ...
        static void randomWord(string wordTip)
        {
            ...
            switch (random())
            {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    wordToGuess = "samambaia";
                    wordTip = "planta";
                    defineList(wordToGuess, wordTip);
                    break;
                case 4:
                    wordToGuess = "natal";
                    wordTip = "data comemorativa";
                    defineList(wordToGuess, wordTip);
                    break;
                case 5:
                    wordToGuess = "feriado";
                ...
                case 8:
                    ...
                    break;
                case 9:
                    wordToGuess = "elevador";
                    wordTip = "substantivo";
                    defineList(wordToGuess, wordTip);
                    break;
                case 10:
                    wordToGuess = "avestruz";
                    wordTip = "animal";
                    defineList(wordToGuess, wordTip);
                    break;
                default:
                    Console.WriteLine("Ocorreu erro na geração de palavras. Investigar");
                    Console.ReadLine();
                    break;
            }
        }
